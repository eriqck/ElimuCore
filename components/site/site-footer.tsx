  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1360px]">
        <div className="grid gap-10 text-center sm:gap-12 lg:grid-cols-[1.2fr_0.9fr_1fr]">
            ...
            <div className="mt-6 space-y-3">
              {footerLinks.map((item) => (
                <Link
                  key={item.label}
                  href={item.href}
                  className="flex w-fit items-center justify-center gap-2 text-sm font-medium text-white/80 transition hover:text-[#25b24a]"
                >
        ...
        <div className="mt-10 flex flex-col items-center gap-4 border-t border-white/10 pt-5 text-center text-sm text-white/55">
